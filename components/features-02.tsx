        ...
        <div className="pt-16 md:pt-32">
          ...
          {/* <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Focus that rewards you
            </h2>
            <p className="text-lg text-slate-400">
              Earn glow berries as you stay in focus mode. Use quick‑launch deep
              links for approved tools, with AI suggesting what to open next
              based on your session goals.
            </p>
          </div> */}
                        ...
                        <div className="mb-5">
                          <div>
                            ...
                            <p className="text-slate-400">
                              Earn glow berries as you stay distraction‑free and
                              trade them for in‑app rewards that celebrate your
                              consistency.
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Launch approved tools instantly with smart deep
                            links so you start fast and stay on task.
                          </p>
                        </div>
                      </div>
                      {/* Image */}
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">
                            Optional focus boosters
                          </h3>
                          <p className="text-slate-400">
                            Add binaural beats and subtle visuals to make deep
                            work sessions more immersive—only if you want them.
                          </p>
                        </div>
                      </div>
                      {/* Image */}
