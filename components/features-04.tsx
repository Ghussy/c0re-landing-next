        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              c0re turns focus into a habit with streaks, plants, and rewards —
              while making it effortless to open the tools you need and block
              the ones you don’t.
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Focus plants</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Collect and grow different plants as you keep your session
                    streaks alive.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Glow berries</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Earn glow berries from your plants as you spend time in
                    focus mode.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Core animal</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Feed berries to your core animal to evolve them and unlock
                    perks.
                  </p>
                </div>
              </div>
            ...
            <div className="py-8">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    We’ll recommend the best app to open next based on your
                    context.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Deep links</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Launch approved tools instantly with one‑tap deep links.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Allowed apps</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Choose which apps and sites are allowed during each session.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Streaks</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Daily and weekly streaks turn focus into a sustainable
                    habit.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Rewards</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Unlock cosmetic upgrades for plants and your core animal as
                    you grow.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    See trends across sessions to fine‑tune your setup and stay
                    in flow.
                  </p>
                </div>
              </div>
